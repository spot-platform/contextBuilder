...
_FACET_POOLS: Dict[str, List[str]] = {
    ...
    "nature": [
        "동네 산책 코스", "꽃 이름 외우기", "계절 식물 관찰", "주말 가벼운 등산",
        "도심 속 작은 정원",
    ],
    "art": [
...
_OBSESSION_POOLS: Dict[str, List[str]] = {
    "music": [
        "요즘 핑거스타일 카피에 푹 빠져 있어요.",
        "어쿠스틱 소품곡 한 곡씩 늘려가는 재미에 꽂혔어요.",
        "녹음해서 들어보는 셀프 피드백이 요즘 즐거워요.",
    ],
    "cooking": [
        "요즘 버터 결 살리는 데 꽂혀 있어요.",
        "남은 재료로 한 그릇 만드는 재미에 빠졌어요.",
        "오븐 온도 잡기에 한참 빠져 있어요.",
    ],
    "exercise": [
        "요즘 야외 러닝 루트 짜는 재미에 빠졌어요.",
        "회복 스트레칭 루틴 만드는 데 꽂혔어요.",
        "초보 페이스 잡기에 요즘 관심이 많아요.",
    ],
    "nature": [
        "요즘 동네 산책 코스 늘려가는 재미에 빠졌어요.",
        "계절마다 바뀌는 식물 관찰이 요즘 즐거워요.",
    ],
    "art": [
        "요즘 10분 드로잉 한 장씩 모으는 재미에 빠졌어요.",
        "스마트폰으로 구도 잡는 연습에 푹 빠져 있어요.",
    ],
    "language": [
        "요즘 관심 주제로 5분 떠들어 보는 챌린지에 빠져 있어요.",
        "표현 노트 채우는 재미에 꽂혔어요.",
    ],
    "study": [
        "요즘 작은 토이 프로젝트 만지작거리는 재미에 빠졌어요.",
    ],
    "culture": [
        "요즘 보드게임 규칙 비교하는 재미에 빠져 있어요.",
        "타로 카드 해석 연습이 요즘 즐거워요.",
    ],
    "food": [
        "요즘 동네 작은 가게 한 줄 평 모으는 재미에 빠졌어요.",
    ],
    "cafe": [
        "요즘 원두 향 메모하는 게 즐거워요.",
    ],
    "bar": [
        "요즘 조용한 동네 바 찾아다니는 재미에 빠졌어요.",
    ],
}
